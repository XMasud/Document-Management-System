...
namespace Record
{
    class ProcessCl
    {
        ...
        {
            Process photo = new Process();
            photo.StartInfo.FileName = "ImageGlass.exe";
            //ProcessStartInfo info = new ProcessStartInfo(@"C:\Program Files (x86)\ImageGlass\\ImageGlass.exe");
            photo.StartInfo.Arguments = @filingPath;
            photo.Start();
        }
    }
}
