    ...
    public partial class TeacherF : Form
    {
        ...
        private void Student_upload_savebtn_Click(object sender, EventArgs e)
        {
            ...
            if (docExists == 0)
            {
                ...
                label15.Text = "Document is Saved" + path;
                showDocumentCount++;
                listbox1Refresh();
                listbox7Refresh();
                listbox6Refresh();
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            label42.Text = "Download Complete" + downloadPath;
        }
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            label25.Text = "Group Deletion Successful" + showGroupCount;
            textBox5.Clear();
            textBox6.Clear();
            showGroupCount++;
            listbox2Refresh();
        ...
        public void showAllGroupFiles()
        {
            ...
            for (int j = 0; j < c; j++)
            {
                ...
                for (int i = 0; i < a; i++)
                {
                    ...
                    infos[1] = temp.getDocName(docId);
                    infos[2] = temp.getDocType(docId);
                    infos[3] = temp.getFilingPath(docId);
                    infos[4] = temp.getDocCheckInTime(docId);
                    infos[5] = temp.getDocSize(docId);
